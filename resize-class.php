<?php
   ...
   # ========================================================================#
		...
		Class resize
		{
			...
			private $optimal_width;
			private $optimal_height;
			...
			private function getDimensions($newWidth, $newHeight, $option)
			{
			   ...
			   switch ($option)
				...
				$this->optimal_width = $optimalWidth;
				$this->optimal_height = $optimalHeight;
			...
			public function display($savePath,$radius=1,$colour='')
			{

				//list( $source_width, $source_height, $source_type ) = getimagesize( $source );
				$source_width = $this->optimal_width;
				$source_height = $this->new_height;

				$source_image = $this->imageResized;
