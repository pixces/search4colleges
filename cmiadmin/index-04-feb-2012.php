<?php
	...
	$student_w=get_record_sql("SELECT COUNT(*) as s_weak FROM {$CFG->prefix}fe_users WHERE added_date>=$week AND user_type = 'student'");
	$student_m=get_record_sql("SELECT COUNT(*) as s_month FROM {$CFG->prefix}fe_users WHERE added_date>=$month AND user_type = 'student'");
	...
	$parents_w=get_record_sql("SELECT COUNT(*) as p_weak FROM {$CFG->prefix}fe_users WHERE added_date>=$week AND user_type = 'parent'");
	$parents_m=get_record_sql("SELECT COUNT(*) as p_month FROM {$CFG->prefix}fe_users WHERE added_date>=$month AND user_type = 'parent'");
	...
	$school_w=get_record_sql("SELECT COUNT(*) as sc_weak FROM {$CFG->prefix}fe_users WHERE added_date>=$week AND user_type = 'school'");
	$school_m=get_record_sql("SELECT COUNT(*) as sc_month FROM {$CFG->prefix}fe_users WHERE added_date>=$month AND user_type = 'school'");
	...
	$teacher_w=get_record_sql("SELECT COUNT(*) as t_weak FROM {$CFG->prefix}fe_users WHERE added_date>=$week AND user_type = 'teacher'");
	$teacher_m=get_record_sql("SELECT COUNT(*) as t_month FROM {$CFG->prefix}fe_users WHERE added_date>=$month AND user_type = 'teacher'");
	...
	$counselor_w=get_record_sql("SELECT COUNT(*) as c_weak FROM {$CFG->prefix}fe_users WHERE added_date>=$week AND user_type = 'counselor'");
	$counselor_m=get_record_sql("SELECT COUNT(*) as c_month FROM {$CFG->prefix}fe_users WHERE added_date>=$month AND user_type = 'counselor'");
	...
	$leads_w=get_record_sql("SELECT COUNT(*) as l_weak FROM {$CFG->prefix}schools_enquiry WHERE added_date>=$week ");
	$leads_m=get_record_sql("SELECT COUNT(*) as l_month FROM {$CFG->prefix}schools_enquiry WHERE added_date>=$month ");
	############################## Query End For leads  #########################
	
	############################## Query For image/videos  #############################
	$iv_d_a=get_record_sql("SELECT COUNT(*) as iv_day_a FROM {$CFG->prefix}school_image_video WHERE added_date>='".strtotime(date("Y-m-d"))."' AND publish=1  ");
	$iv_d_d=get_record_sql("SELECT COUNT(*) as iv_day_d FROM {$CFG->prefix}school_image_video WHERE added_date>='".strtotime(date("Y-m-d"))."' AND publish=0");
	$iv_w_a=get_record_sql("SELECT COUNT(*) as iv_weak_a FROM {$CFG->prefix}school_image_video WHERE added_date>=$week AND publish=0");
	$iv_w_d=get_record_sql("SELECT COUNT(*) as iv_weak_d FROM {$CFG->prefix}school_image_video WHERE added_date>=$week AND publish=1");
	$iv_m_a=get_record_sql("SELECT COUNT(*) as iv_month_a FROM {$CFG->prefix}school_image_video WHERE added_date>=$month  AND publish=0");
	$iv_m_d=get_record_sql("SELECT COUNT(*) as iv_month_d FROM {$CFG->prefix}school_image_video WHERE added_date>=$month  AND publish=1");
	...
	$articles_w=get_record_sql("SELECT COUNT(*) as a_weak FROM {$CFG->prefix}articles WHERE added_date>=$week ");
	$articles_m=get_record_sql("SELECT COUNT(*) as a_month FROM {$CFG->prefix}articles WHERE added_date>=$month ");
	...
	$membership_w=get_record_sql("SELECT  COUNT(*) as week, SUM(total_amount) as week_sum FROM {$CFG->prefix}school_membership as m WHERE m.added_date>=$week  AND m.status='active'");
	$membership_m=get_record_sql("SELECT  COUNT(*) as month, SUM(total_amount) as month_sum FROM {$CFG->prefix}school_membership as m WHERE m.added_date>=$month  AND m.status='active'");
                                    ...
                                    <td width="50%">
                                                    <table width="90%" border="1" cellspacing="0" cellpadding="0" class="main_header" >
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td align="left">&nbsp;<?php echo $iv_d_a->iv_day_a+$iv_d_d->iv_day_d; ?></td>
                                                              </tr>
                                                              <tr>
                                                                ...
                                                                <td align="left">&nbsp;<?php echo $iv_w_a->iv_weak_a+$iv_w_d->iv_weak_d; ?></td>
                                                              </tr>
                                                              <tr>
                                                                ...
                                                                <td align="left">&nbsp;<?php echo $iv_m_a->iv_month_a+$iv_m_d->iv_month_d; ?></td>
                                                              </tr>
                                                    </table>
                                    </td>
                                    <td width="50%">
