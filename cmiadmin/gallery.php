<?php 
	...
	{
		$table->head = array ($id, $name, $image,"");
		...
		foreach ($master_data as $data)
		{
			...
			$editbutton = get_buttons("Edit $page_title" ,"$page_form?edit_load=$data->id","theme/$theme/images/edit.gif", "rel='lightbox'");
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td>
				...
				<a href="<?php echo $page_form; ?>" style="float:right;margin-right:60px;" rel="lightbox" class="clearfix"  title=":: Add <?php echo $page_title; ?>">
