<?php 
	...
	$decription='';
	$message	= "";
	$master_table_name = 'school_degrees_offered';	
	...
	$perpage		= 10;      
	$txtsearch_degree	= optional_param('txtsearch_degree', '', PARAM_RAW);
	...
	$page_arr		= array(
							...
							'perpage'		=> $perpage,
							'page'			=> $page,
							'txtsearch_degree'=> $txtsearch_degree
						);	
	...
	$columns = array('id','degree','');
	$column = get_sorting_header($page_arr,$page_name,$theme,$columns);
	extract($column);

	$sort_term		= $sort." ".$dir;				
	$searchfields	= array("degree");
	$extraselect	= " status != 'delete' ";
	if($txtsearch_degree!='')
	{
		$extraselect .= " AND degree LIKE '%".$txtsearch_degree."%'";
	}

	$master_data = get_cmi_records($master_table_name, true, '*', $txtsearch_degree, $searchfields, $extraselect, $sort_term, $page, $perpage);
	$master_count = get_cmi_records($master_table_name, false, '', $txtsearch_degree, $searchfields, $extraselect);
									...
									<td class="Label" align="center" width="90%">
										<table>
											<tr>
												<td>Degree&nbsp;:&nbsp; </td>
												<td>
													<input type="text" size="40" name="txtsearch_degree" id="txtsearch_degree" class="txtBox" value="<?php echo $txtsearch_degree; ?>">
												</td>
											</tr>											
											<tr>
												<td colspan="2">
													<center>
														...
														<input name="btnreset" id="btnreset" type="button" value="Reset" onclick="txtsearch_degree.value=''">
