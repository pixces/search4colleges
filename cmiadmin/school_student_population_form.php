<?php 
	...
	$theme = current_theme();		
	$message = $title = '';
	$master_table_name = 'school_student_population';
...
<?php
	...
	{			
		...
		{
			cmi_add_to_log('School Student Population','Insert','New school_student_population '.$title.' added');
?>	
			<script  type="text/javascript">
				parent.window.location = '<?php echo $page_manage; ?>';
				parent.Mediabox.close();			
					...
					<table border="0" width="100%" align="center" cellspacing="1" cellpadding="1">
						<tbody>
							...
							<tr>
								...
								<td >
									<input name="title" class="validate['required'] txtBox" type="text" size="40" value="<?php echo $title; ?>" />
								</td>
							</tr>	
							<tr>
								<td colspan="2"><br></td>												
