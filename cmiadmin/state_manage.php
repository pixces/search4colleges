<?php 
	...
	$columns = array('id','name','category');
	...
	{
		$table->head = array ($id, $name,"Country","");
		...
		foreach ($master_data as $data)
		{
			...
			$edit_data1		= get_record('country', 'id', $data->country_id);
			...
			//$element  .= get_field('majors','name','id',$data->parent_id);
