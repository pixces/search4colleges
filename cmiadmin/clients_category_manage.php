<?php 
	...
	$message	= "";
	$master_table_name = 'clients_category';	
	...
	{
		$table->head = array ($id, $name,$short_description,"");
		...
		foreach ($master_data as $data)
		{
			...
			$editbutton = get_buttons("Edit $page_title", "$page_form?edit_load=$data->id","theme/$theme/images/edit.gif", "rel='lightbox[set2 600 400]'");
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td>
				...
				<a href="<?php echo $page_form; ?>" style="float:right;margin-right:60px;" rel="lightbox[set1 600 400]" class="clearfix"  title=":: Add <?php echo $page_title;?>">
