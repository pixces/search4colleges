...
$statistics_status_text=($statistics_status->statistics_view_status) ? 'Click to disable statistics' :'Click to enable statistics';
$statistics_status_text1=($statistics_status->statistics_view_status) ? 'Statistics Enabled' :'Statistics Disabled';
$statistics_style=($statistics_status->statistics_view_status)?'style="color:red"':'style="color:#000"';
############################## Query End For  Articles  #########################
?>	
...
<tr>
    <td VALIGN="top" style="">
        ...
        <span style='font-weight:bold;color:#61210B ;width:300px;float:left;position:relative;'>
            <a href="javascript:void(0);" onclick='javascript:toogleStatistics();' >
                <img id="statistics_status"  alt='<?php echo $statistics_status_text?>' title='<?php echo $statistics_status_text?>' height="16" width="16" border="0" class="Bg8" src="theme/cmi/images/statistics.png">
            </a>
            <span id="statistics_status_text" style="position: relative;top: -23px;left: 29px;">
                <div <?php echo $statistics_style?>>(<?php echo $statistics_status_text1;?>)</div>
            </span>
        </span>
...
<script type="text/javascript">
    function toogleStatistics(){
       
       var req = new Request({
				 method: 'post',
				 url: 'ajax_handler.php',
				 data: {'flag' : 'toogleStatistics'						
					 },
				 onRequest: function() {},
				 onComplete: function(response) {
                                        ...
                                        switch(obj.update_error_code){
                                          case 0:
                                              var status=obj.status;
                                              var text=obj.text;
                                              //var imagesrc=(status)?'theme/cmi/images/active_static.png':'theme/cmi/images/statistics.png'
                                              document.getElementById("statistics_status").setAttribute("alt", text);
                                              document.getElementById("statistics_status").setAttribute("title", text);
                                              //document.getElementById("statistics_status").setAttribute("src", imagesrc);
                                              var statistics_status_text=(status)?'<div style="color:red;">(Statistics Enabled)</div>':'<div style="color:#000;">(Statistics Disabled)</div>'
                                              document.getElementById("statistics_status_text").innerHTML=statistics_status_text;
                                          break;
                                          case 1:
                                        ...
                                        $('statistics_status').innerHTML = response;
				}
			}).send();
