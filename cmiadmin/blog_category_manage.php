<?php 
	...
	$columns = array("id", "title","sort_order");	
	...
	{
		$table->head = array ($id,$title,$sort_order,"");
		...
		foreach ($master_data as $data)
		{
			...
			$editbutton = get_buttons("Edit $page_title" ,"$page_form?edit_load=$data->id","theme/$theme/images/edit.gif", "rel='lightbox[edit_$data->id 500 200]'");
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td>
				...
				<a href="<?php echo $page_form; ?>" style="float:right;margin-right:60px;" rel="lightbox[set2 500 200]" class="tipz"  title=":: Add <?php echo $page_title; ?>">
