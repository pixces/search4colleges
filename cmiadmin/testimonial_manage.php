<?php 
	...
	{
		$extraselect .=" AND sender_name LIKE '%".$txtsearch_sender_name."%'";
	}
	...
	{
		$table->head = array ($id,'Title',$sender_name,'Preview',"");
		...
		foreach ($master_data as $data)
		{
			...
			$editbutton = get_buttons("Edit $page_title" ,"$page_form?edit_load=$data->id","theme/$theme/images/edit.gif", "rel='lightbox[edit_$data->id 600 400]'");
			...
			$table->data[] = array (
					...
					"$data->name",		
					"$data->sender_name",									
					"<a href='$CFG->siteroot/file.php/$master_image_path/$data->image' rel ='lightbox' title=' $data->image'><img src='$CFG->siteroot/file.php/$master_image_path/f1_$data->image' alt='$data->name'/></a>",
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td>
				...
				<a href="<?php echo $page_form; ?>" style="float:right;margin-right:60px;" rel="lightbox[set2 600 400]" class="tipz"  title=":: Add <?php echo $page_title; ?>">
