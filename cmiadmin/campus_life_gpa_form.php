<?php 
	...
	$gpa = optional_param('gpa','', PARAM_TEXT);	
...
<?php
	...
	{			
		...
		{
			cmi_add_to_log('Campus Life Qpa ','Insert','New campuslife_qpa '.$gpa.' added');
?>	
			<script  type="text/javascript">
				parent.window.location = '<?php echo $page_manage; ?>';
				parent.Mediabox.close();			
					...
					<table border="0" width="100%" align="center" cellspacing="1" cellpadding="1">
						<tbody>
							...
							<tr>
								...
								<td >
									<input name="gpa" class="validate['required'] txtBox" type="text" size="40" value="<?php echo $gpa; ?>" />
								</td>
							</tr>	
							<tr>
								<td colspan="2"><br></td>												
