			...
			<td>
				...
				<form method="post" name="frm_add_mode" id="frm_add_mode" action="<?php echo $page_name; ?>" enctype="multipart/form-data">
					<table border="0" width="100%" align="center" cellspacing="1" cellpadding="1">
						<tbody>
							<tr>
								<td colspan="0" class="Label" width="20%"><span style="font-size: 12px; font-family : Verdana;"><?php echo get_string('label_category','cmi'); ?></span>
								</td>
								<td>
									<select id="category" name="category" class="txtBox">
									<?php echo get_category_option($category); ?>									
									</select>
								</td>
								 <td>&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td class="Label" width="20%"><span style="font-size: 12px; font-family : Verdana;">Name</span> : </td>
								<td >
									<input name="name" class="validate['required'] txtBox" type="text" size="40" value="<?php if(isset($name)) echo $name;?>" />
								</td>
							</tr>
							<tr>
								<td class="Label" width="20%"><span style="font-size: 12px; font-family : Verdana;">Seo Keyword</span> : </td>
								<td>
									<input id="seo_keyword" name="seo_keyword" class="validate['required','seo'] taken txtBox" type="text" size="40" value="<?php if(isset($seo_keyword)) echo $seo_keyword;?>" />
