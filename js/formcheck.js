...
var FormCheck = new Class({
	...
	options : {
		...
		alerts : {
			required : "This field is required.",
			alpha : "This field accepts alphabetic characters only.",
			seo : "This field accepts alphanumeric characters, '-' and '_'.",
			alphanum : "This field accepts alphanumeric characters only.",
			nodigit : "No digits are accepted.",
			digit : "Please enter a valid integer.",
			digitltd : "The value must be between %0 and %1",
			...
			image : 'This field should only contain image types', 
			only_image : 'This field should only contain image types', 
			pdf : 'This field should only contain PDF file types', 
			documents : 'This field should only contain PDF,doc,xls file types',
			flv : 'This field should only contain Video file types', 
			videos : 'This field should only contain Video file types like flv,3gp,mp4',
			phone : "Please enter a valid phone.",
			phone_inter : "Please enter a valid international phone number.",
		...
		regexp : {
			...
			only_image : /.(jpg|jpeg|png|gif)$/i,
			pdf : /.(pdf)$/i,
			documents : /.(pdf|doc|docx|xls)$/i,
			flv : /.(flv)$/i,
			videos : /.(flv|3gp|mp4)$/i,
